 ...
 * 
 */
@WebServiceClient(name = "HelloImplService", targetNamespace = "http://service.bp.com/", wsdlLocation = "http://localhost:8989/webservice20160317/hellows?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOIMPLSERVICE_QNAME = new QName("http://service.bp.com/", "HelloImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8989/webservice20160317/hellows?wsdl");
    ...
    public HelloImpl getHelloImplPort() {
        return super.getPort(new QName("http://service.bp.com/", "HelloImplPort"), HelloImpl.class);
    }
    ...
    public HelloImpl getHelloImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.bp.com/", "HelloImplPort"), HelloImpl.class, features);
    }
